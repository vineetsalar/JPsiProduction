...
void Plot_PaperFigures_Pt() 
{
  ...
  //================================ Open Chic Root File ================================================//
  TFile *file1_ChiC = new TFile("2107PtTest_ChiCCalculations.root","R");
 ...
 //============================ ALICE RAA Vs Pt Graphs =======================//
  ...
  TGraph *ChiC_grGluonDissALICEPt_M =(TGraph*)file1_ChiC->Get("grGluonDissALICEPt_M");
  ChiC_grGluonDissALICEPt_M->SetLineColor(2);
  ChiC_grGluonDissALICEPt_M->SetLineStyle(2);
  ChiC_grGluonDissALICEPt_M->SetLineWidth(2);

  
  TGraph *ChiC_grPionDissALICEPt_M =(TGraph*)file1_ChiC->Get("grPionDissALICEPt_M");
  ...
  TGraph *ChiC_grShadowDissALICEPt_M =(TGraph*)file1_ChiC->Get("grShadowDissALICEPt_M");
  ChiC_grShadowDissALICEPt_M->SetLineColor(6);
  ChiC_grShadowDissALICEPt_M->SetLineStyle(6);
  ChiC_grShadowDissALICEPt_M->SetLineWidth(2);


  TGraph *ChiC_grRegenALICEPt_M =(TGraph*)file1_ChiC->Get("grRegenALICEPt_M");
  ...
  TGraph *ChiC_grRAAALICEPt_M =(TGraph*)file1_ChiC->Get("grRAAALICEPt_M");
 ...
 //============================ CMS RAA Vs Pt Graphs =======================//
  ...
  TGraph *ChiC_grGluonDissCMSPt_M =(TGraph*)file1_ChiC->Get("grGluonDissCMSPt_M");
  ChiC_grGluonDissCMSPt_M->SetLineColor(2);
  ChiC_grGluonDissCMSPt_M->SetLineStyle(2);
  ChiC_grGluonDissCMSPt_M->SetLineWidth(2);


  TGraph *ChiC_grPionDissCMSPt_M =(TGraph*)file1_ChiC->Get("grPionDissCMSPt_M");
  ChiC_grPionDissCMSPt_M->SetLineColor(4);
  ChiC_grPionDissCMSPt_M->SetLineStyle(4);
  ChiC_grPionDissCMSPt_M->SetLineWidth(2);


  TGraph *ChiC_grShadowDissCMSPt_M =(TGraph*)file1_ChiC->Get("grShadowDissCMSPt_M");
  ChiC_grShadowDissCMSPt_M->SetLineColor(6);
  ChiC_grShadowDissCMSPt_M->SetLineStyle(6);
  ChiC_grShadowDissCMSPt_M->SetLineWidth(2);




  TGraph *ChiC_grRegenCMSPt_M =(TGraph*)file1_ChiC->Get("grRegenCMSPt_M");
  ...
  TGraph *ChiC_grRAACMSPt_M =(TGraph*)file1_ChiC->Get("grRAACMSPt_M");
  ChiC_grRAACMSPt_M->SetLineColor(1);
  ChiC_grRAACMSPt_M->SetLineStyle(1);
  ChiC_grRAACMSPt_M->SetLineWidth(2);
 

  TGraph  *ChiC_grGluonDissALICENPart_M;
  TGraph  *ChiC_grPionDissALICENPart_M;
  TGraph  *ChiC_grRegenALICENPart_M;
  TGraph  *ChiC_grRAAALICENPart_M;
  TGraph  *ChiC_grGluonDissCMSNPart_M;
  TGraph  *ChiC_grPionDissCMSNPart_M;
  TGraph  *ChiC_grRegenCMSNPart_M;
  TGraph  *ChiC_grRAACMSNPart_M;

  if(IsNpart ==1){
    //============================ ALICE RAA Vs NPart Graphs =======================//
    ChiC_grGluonDissALICENPart_M =(TGraph*)file_ChiC->Get("grDissALICE_M");
    ...
    ChiC_grPionDissALICENPart_M =(TGraph*)file_ChiC->Get("grPionDissALICE_M");
    ...
    ChiC_grGluonDissCMSNPart_M =(TGraph*)file_ChiC->Get("grDissCMS_M");
    ...
    ChiC_grRAACMSNPart_M =(TGraph*)file_ChiC->Get("grRAACMS_M");
  ...
  TFile *file1_Psi2S = new TFile("2107PtTest_PsiCalculations.root","R");
 ...
 //============================ ALICE RAA Vs Pt Graphs =======================//
  TGraph *Psi2S_grGluonDissALICEPt_M =(TGraph*)file1_Psi2S->Get("grGluonDissALICEPt_M");
  ...
  TGraph *Psi2S_grPionDissALICEPt_M =(TGraph*)file1_Psi2S->Get("grPionDissALICEPt_M");
  Psi2S_grPionDissALICEPt_M->SetLineColor(4);
  Psi2S_grPionDissALICEPt_M->SetLineStyle(4);
  Psi2S_grPionDissALICEPt_M->SetLineWidth(2);


  TGraph *Psi2S_grShadowDissALICEPt_M =(TGraph*)file1_Psi2S->Get("grShadowDissALICEPt_M");
  Psi2S_grShadowDissALICEPt_M->SetLineColor(6);
  Psi2S_grShadowDissALICEPt_M->SetLineStyle(6);
  Psi2S_grShadowDissALICEPt_M->SetLineWidth(2);




  TGraph *Psi2S_grRegenALICEPt_M =(TGraph*)file1_Psi2S->Get("grRegenALICEPt_M");
  ...
  TGraph *Psi2S_grRAAALICEPt_M =(TGraph*)file1_Psi2S->Get("grRAAALICEPt_M");
 ...
 //============================ CMS RAA Vs Pt Graphs =======================//
  ...
  TGraph *Psi2S_grGluonDissCMSPt_M =(TGraph*)file1_Psi2S->Get("grGluonDissCMSPt_M");
  Psi2S_grGluonDissCMSPt_M->SetLineColor(2);
  Psi2S_grGluonDissCMSPt_M->SetLineStyle(2);
  Psi2S_grGluonDissCMSPt_M->SetLineWidth(2);


  TGraph *Psi2S_grPionDissCMSPt_M =(TGraph*)file1_Psi2S->Get("grPionDissCMSPt_M");
  ...
  TGraph *Psi2S_grShadowDissCMSPt_M =(TGraph*)file1_Psi2S->Get("grShadowDissCMSPt_M");
  Psi2S_grShadowDissCMSPt_M->SetLineColor(6);
  Psi2S_grShadowDissCMSPt_M->SetLineStyle(6);
  Psi2S_grShadowDissCMSPt_M->SetLineWidth(2);


  TGraph *Psi2S_grRegenCMSPt_M =(TGraph*)file1_Psi2S->Get("grRegenCMSPt_M");
  ...
  TGraph *Psi2S_grRAACMSPt_M =(TGraph*)file1_Psi2S->Get("grRAACMSPt_M");
  ...
  TGraph  *Psi2S_grGluonDissALICENPart_M;
  TGraph  *Psi2S_grPionDissALICENPart_M;
  TGraph  *Psi2S_grRegenALICENPart_M;
  TGraph  *Psi2S_grRAAALICENPart_M;
  TGraph  *Psi2S_grGluonDissCMSNPart_M;
  TGraph  *Psi2S_grPionDissCMSNPart_M;
  TGraph  *Psi2S_grRegenCMSNPart_M;
  TGraph  *Psi2S_grRAACMSNPart_M;
 ...
 //============================ ALICE RAA Vs NPart Graphs =======================//
  ...
  Psi2S_grGluonDissALICENPart_M =(TGraph*)file_Psi2S->Get("grDissALICE_M");
  ...
  Psi2S_grPionDissALICENPart_M =(TGraph*)file_Psi2S->Get("grPionDissALICE_M");
  ...
  Psi2S_grRegenALICENPart_M =(TGraph*)file_Psi2S->Get("grFormALICE_M");
  ...
  Psi2S_grRAAALICENPart_M =(TGraph*)file_Psi2S->Get("grRAAALICE_M");
...
//============================ CMS RAA Vs NPart Graphs =======================//
  ...
  Psi2S_grGluonDissCMSNPart_M =(TGraph*)file_Psi2S->Get("grDissCMS_M");
  ...
  Psi2S_grPionDissCMSNPart_M =(TGraph*)file_Psi2S->Get("grPionDissCMS_M");
  ...
  Psi2S_grRegenCMSNPart_M =(TGraph*)file_Psi2S->Get("grFormCMS_M");
  ...
  Psi2S_grRAACMSNPart_M =(TGraph*)file_Psi2S->Get("grRAACMS_M");
  ...
  TFile *file1_JPsi = new TFile("2107PtTest_JPsiCalculations.root","R");
...
// ====== Formation rate graphs ==============================//
 ...
 //============================ ALICE RAA Vs Pt Graphs =======================//
  ...
  TGraph *JPsi_grGluonDissALICEPt_M =(TGraph*)file1_JPsi->Get("grGluonDissALICEPt_M");
  JPsi_grGluonDissALICEPt_M->SetLineColor(2);
  JPsi_grGluonDissALICEPt_M->SetLineStyle(2);
  JPsi_grGluonDissALICEPt_M->SetLineWidth(2);


  TGraph *JPsi_grPionDissALICEPt_M =(TGraph*)file1_JPsi->Get("grPionDissALICEPt_M");
  ...
  TGraph *JPsi_grShadowDissALICEPt_M =(TGraph*)file1_JPsi->Get("grShadowDissALICEPt_M");
  JPsi_grShadowDissALICEPt_M->SetLineColor(6);
  JPsi_grShadowDissALICEPt_M->SetLineStyle(6);
  JPsi_grShadowDissALICEPt_M->SetLineWidth(2);


  TGraph *JPsi_grRegenALICEPt_M =(TGraph*)file1_JPsi->Get("grRegenALICEPt_M");
  ...
  TGraph *JPsi_grRAAALICEPt_M =(TGraph*)file1_JPsi->Get("grRAAALICEPt_M");
 ...
 //============================ CMS RAA Vs Pt Graphs =======================//
  ...
  TGraph *JPsi_grGluonDissCMSPt_M =(TGraph*)file1_JPsi->Get("grGluonDissCMSPt_M");
  JPsi_grGluonDissCMSPt_M->SetLineColor(2);
  JPsi_grGluonDissCMSPt_M->SetLineStyle(2);
  JPsi_grGluonDissCMSPt_M->SetLineWidth(2);


  TGraph *JPsi_grPionDissCMSPt_M =(TGraph*)file1_JPsi->Get("grPionDissCMSPt_M");
  ...
  TGraph *JPsi_grShadowDissCMSPt_M =(TGraph*)file1_JPsi->Get("grShadowDissCMSPt_M");
  JPsi_grShadowDissCMSPt_M->SetLineColor(6);
  JPsi_grShadowDissCMSPt_M->SetLineStyle(6);
  JPsi_grShadowDissCMSPt_M->SetLineWidth(2);


  TGraph *JPsi_grRegenCMSPt_M =(TGraph*)file1_JPsi->Get("grRegenCMSPt_M");
  ...
  TGraph *JPsi_grRAACMSPt_M =(TGraph*)file1_JPsi->Get("grRAACMSPt_M");
  ...
  TGraph  *JPsi_grGluonDissALICENPart_M;
  TGraph  *JPsi_grPionDissALICENPart_M;
  TGraph  *JPsi_grRegenALICENPart_M;
  TGraph  *JPsi_grRAAALICENPart_M;
  TGraph  *JPsi_grGluonDissCMSNPart_M;
  TGraph  *JPsi_grPionDissCMSNPart_M;
  TGraph  *JPsi_grRegenCMSNPart_M;
  TGraph  *JPsi_grRAACMSNPart_M;
  ...
  JPsi_grGluonDissALICENPart_M =(TGraph*)file_JPsi->Get("grDissALICE_M");
  ...
  JPsi_grPionDissALICENPart_M =(TGraph*)file_JPsi->Get("grPionDissALICE_M");
  ...
  JPsi_grRegenALICENPart_M =(TGraph*)file_JPsi->Get("grFormALICE_M");
  ...
  JPsi_grRAAALICENPart_M =(TGraph*)file_JPsi->Get("grRAAALICE_M");
...
//============================ CMS RAA Vs NPart Graphs =======================//
  ...
  JPsi_grGluonDissCMSNPart_M =(TGraph*)file_JPsi->Get("grDissCMS_M");
  ...
  JPsi_grRAACMSNPart_M =(TGraph*)file_JPsi->Get("grRAACMS_M");
  ...
  Double_t ChiCBR = 0.014;
  Double_t Psi2SBR = 0.59;
  Double_t JPsiBR = 1.0;
  ...
  for (int j=0; j < JPsi_grRAAALICEPt_M->GetN();++j){
    ...
    Double_t Psi2S_Gluon, Psi2S_Pion, Psi2S_Shadow,Psi2S_Regen,Psi2S_Total;
    Double_t ChiC_Gluon, ChiC_Pion, ChiC_Shadow,ChiC_Regen,ChiC_Total;

    
    JPsi_grGluonDissALICEPt_M->GetPoint(j,Pt,JPsi_Gluon);
    Psi2S_grGluonDissALICEPt_M->GetPoint(j,Pt,Psi2S_Gluon);
    ChiC_grGluonDissALICEPt_M->GetPoint(j,Pt,ChiC_Gluon);


    JPsi_grPionDissALICEPt_M->GetPoint(j,Pt,JPsi_Pion);
    Psi2S_grPionDissALICEPt_M->GetPoint(j,Pt,Psi2S_Pion);
    ChiC_grPionDissALICEPt_M->GetPoint(j,Pt,ChiC_Pion);
    
    
    JPsi_grShadowDissALICEPt_M->GetPoint(j,Pt,JPsi_Shadow);
    Psi2S_grShadowDissALICEPt_M->GetPoint(j,Pt,Psi2S_Shadow);
    ChiC_grShadowDissALICEPt_M->GetPoint(j,Pt,ChiC_Shadow);


    JPsi_grRegenALICEPt_M->GetPoint(j,Pt,JPsi_Regen);
    Psi2S_grRegenALICEPt_M->GetPoint(j,Pt,Psi2S_Regen);
    ChiC_grRegenALICEPt_M->GetPoint(j,Pt,ChiC_Regen);
    
    JPsi_Total=JPsi_Gluon*JPsi_Pion*JPsi_Shadow;
    Psi2S_Total=Psi2S_Gluon*Psi2S_Pion*Psi2S_Shadow;
    ChiC_Total=ChiC_Gluon*ChiC_Pion*ChiC_Shadow;



    RAATotal = JPsiFactor*JPsi_Total +  JPsiBR*JPsi_Regen + Psi2SFactor*Psi2S_Total +  Psi2SBR*Psi2S_Regen + ChiCFactor*ChiC_Total +  ChiCBR*ChiC_Regen;    

    GluonTotal = JPsiFactor*JPsi_Gluon + Psi2SFactor* Psi2S_Gluon +  ChiCFactor*ChiC_Gluon;
    PionTotal = JPsiFactor*JPsi_Pion + Psi2SFactor* Psi2S_Pion +  ChiCFactor*ChiC_Pion;
    ShadowTotal = JPsiFactor*JPsi_Shadow + Psi2SFactor* Psi2S_Shadow +  ChiCFactor*ChiC_Shadow;
    
    RegenTotal = JPsiBR*JPsi_Regen + Psi2SBR*Psi2S_Regen +  ChiCBR*ChiC_Regen;
    ...
    JPsi_grShadowDissALICEPt_M->SetPoint(j,Pt,ShadowTotal);  
  ...
  legd1->AddEntry(JPsi_grShadowDissALICEPt_M,"CNM Effects","L");
  ...
  JPsi_grShadowDissALICEPt_M->Draw("Lsame");
 ...
 for (int j=0; j < JPsi_grRAACMSPt_M->GetN();++j){
   ...
   Double_t Pt,GluonTotal,PionTotal,ShadowTotal,RegenTotal,RAATotal;
    ...
    Psi2S_grGluonDissCMSPt_M->GetPoint(j,Pt,Psi2S_Gluon);
    ChiC_grGluonDissCMSPt_M->GetPoint(j,Pt,ChiC_Gluon);


    JPsi_grPionDissCMSPt_M->GetPoint(j,Pt,JPsi_Pion);
    Psi2S_grPionDissCMSPt_M->GetPoint(j,Pt,Psi2S_Pion);
    ChiC_grPionDissCMSPt_M->GetPoint(j,Pt,ChiC_Pion);
    
    
    JPsi_grShadowDissCMSPt_M->GetPoint(j,Pt,JPsi_Shadow);
    Psi2S_grShadowDissCMSPt_M->GetPoint(j,Pt,Psi2S_Shadow);
    ChiC_grShadowDissCMSPt_M->GetPoint(j,Pt,ChiC_Shadow);


    JPsi_grRegenCMSPt_M->GetPoint(j,Pt,JPsi_Regen);
    Psi2S_grRegenCMSPt_M->GetPoint(j,Pt,Psi2S_Regen);
    ChiC_grRegenCMSPt_M->GetPoint(j,Pt,ChiC_Regen);
    ...
    JPsi_grShadowDissCMSPt_M->SetPoint(j,Pt,ShadowTotal);  
 ...
 legd2->AddEntry(JPsi_grShadowDissCMSPt_M,"CNM Effects","L");
 ...
 JPsi_grShadowDissCMSPt_M->Draw("Lsame");
 ...
 // ================= RAA Vs NPart Graphs for charmonia with feed down =====================//
  ...
  for (int j=0; j < JPsi_grRAAALICENPart_M->GetN();++j){
    ...
    Psi2S_grGluonDissALICENPart_M->GetPoint(j,NPart,Psi2S_Gluon);
    ChiC_grGluonDissALICENPart_M->GetPoint(j,NPart,ChiC_Gluon);


    JPsi_grPionDissALICENPart_M->GetPoint(j,NPart,JPsi_Pion);
    Psi2S_grPionDissALICENPart_M->GetPoint(j,NPart,Psi2S_Pion);
    ChiC_grPionDissALICENPart_M->GetPoint(j,NPart,ChiC_Pion);
    
    
    JPsi_grShadowDissALICENPart_M->GetPoint(j,NPart,JPsi_Shadow);
    Psi2S_grShadowDissALICENPart_M->GetPoint(j,NPart,Psi2S_Shadow);
    ChiC_grShadowDissALICENPart_M->GetPoint(j,NPart,ChiC_Shadow);


    JPsi_grRegenALICENPart_M->GetPoint(j,NPart,JPsi_Regen);
    Psi2S_grRegenALICENPart_M->GetPoint(j,NPart,Psi2S_Regen);
    ChiC_grRegenALICENPart_M->GetPoint(j,NPart,ChiC_Regen);
    ...
    JPsi_grShadowDissALICENPart_M->SetPoint(j,NPart,ShadowTotal);  
 ...
 */
 ...
 Double_t ChiBFactor = 1.0;
 Double_t Y3SFactor = 1.0;
 Double_t Y2SFactor = 1.0;
 Double_t Y1SFactor = 1.0;
