...

{
  ...
  /*
  TFile *file_Shadowing =  new TFile("InRootFiles/ShawQuarkonia.root","R");
 ...
 TFile *file_Shadowing =  new TFile("01052015_InRootFiles/2804_ShawQuarkonia_NPart.root","R");

  TGraph *grShJPsiVsPtALICE_Shade =(TGraph*)file_Shadowing->Get("grShJPsiVsPt_Y2440_Shade");
  //TGraph *grShJPsiVsPtALICE =(TGraph*)file_Shadowing->Get("grShJPsiVsPt_Y2440");
  TGraph *grShUJPsiVsPtALICE =(TGraph*)file_Shadowing->Get("grShUJPsiVsPt_Y2440");
  TGraph *grShLJPsiVsPtALICE =(TGraph*)file_Shadowing->Get("grShLJPsiVsPt_Y2440");


  TGraph *grShJPsiVsPtCMS_Shade =(TGraph*)file_Shadowing->Get("grShJPsiVsPt_Y21_Shade");
  //TGraph *grShJPsiVsPtCMS =(TGraph*)file_Shadowing->Get("grShJPsiVsPt_Y21");
  TGraph *grShUJPsiVsPtCMS =(TGraph*)file_Shadowing->Get("grShUJPsiVsPt_Y21");
  TGraph *grShLJPsiVsPtCMS =(TGraph*)file_Shadowing->Get("grShLJPsiVsPt_Y21");



  TGraph *grShJPsiVsNPart_Shade =(TGraph*)file_Shadowing->Get("grShJPsiVsNPart_Y2440_Shade");
  //TGraph *grShJPsiVsNPart =(TGraph*)file_Shadowing->Get("grShJPsiVsNPart_Y2440");
  TGraph *grShUJPsiVsNPart =(TGraph*)file_Shadowing->Get("grShUJPsiVsNPart_Y2440");
  TGraph *grShLJPsiVsNPart =(TGraph*)file_Shadowing->Get("grShLJPsiVsNPart_Y2440");



  TGraph *grShJPsiPtCutVsNPart_Shade =(TGraph*)file_Shadowing->Get("grShJPsiPtCutVsNPart_Y21_Shade");
  //TGraph *grShJPsiPtCutVsNPart =(TGraph*)file_Shadowing->Get("grShJPsiPtCutVsNPart_Y21");
  TGraph *grShUJPsiPtCutVsNPart =(TGraph*)file_Shadowing->Get("grShUJPsiPtCutVsNPart_Y21");
  TGraph *grShLJPsiPtCutVsNPart =(TGraph*)file_Shadowing->Get("grShLJPsiPtCutVsNPart_Y21");


  TGraph *grShJPsiVsNPart_Y1_Shade =(TGraph*)file_Shadowing->Get("grShJPsiVsNPart_Y1_Shade");
  //TGraph *grShJPsiVsNPart_Y1 =(TGraph*)file_Shadowing->Get("grShJPsiVsNPart_Y1");
  TGraph *grShUJPsiVsNPart_Y1 =(TGraph*)file_Shadowing->Get("grShUJPsiVsNPart_Y1");
  TGraph *grShLJPsiVsNPart_Y1 =(TGraph*)file_Shadowing->Get("grShLJPsiVsNPart_Y1");
  ...
  TGraph *grShUpsilonVsNPartFor_Shade =(TGraph*)file_Shadowing->Get("grShUpsilonVsNPartFor_Shade");
  //TGraph *grShUpsilonVsNPartFor =(TGraph*)file_Shadowing->Get("grShUpsilonVsNPartFor");
  TGraph *grShUUpsilonVsNPartFor =(TGraph*)file_Shadowing->Get("grShUpsilonUVsNPartFor");
  TGraph *grShLUpsilonVsNPartFor =(TGraph*)file_Shadowing->Get("grShUpsilonLVsNPartFor");
  ...
  TFile *file_Rates;
  file_Rates = new TFile("InRootFiles/Rates_JPsiCalculations.root","R");
  
  
  if(VarSet ==1){
    file_JPsi = new TFile("InRootFiles/04032015_JPsiCalculations.root","R");
    file_JPsi_V1 = new TFile("InRootFiles/SigmaDFac05_JPsiCalculations.root","R");
    file_JPsi_V2 = new TFile("InRootFiles/SigmaDFac15_JPsiCalculations.root","R");
    file_JPsi_V3= new TFile("InRootFiles/Tau001_JPsiCalculations.root","R");
    file_JPsi_V4 = new TFile("InRootFiles/Tau006_JPsiCalculations.root","R");
  }

  
  if(VarSet ==2){
    file_JPsi = new TFile("InRootFiles/04032015_JPsiCalculations.root","R");
    file_JPsi_V1 = new TFile("InRootFiles/SigmaDFac08_JPsiCalculations.root","R");
    file_JPsi_V2 = new TFile("InRootFiles/SigmaDFac12_JPsiCalculations.root","R");
    file_JPsi_V3= new TFile("InRootFiles/Tau002_JPsiCalculations.root","R");
    file_JPsi_V4 = new TFile("InRootFiles/Tau004_JPsiCalculations.root","R");
  }



  if(VarSet ==3){
    //file_JPsi = new TFile("InRootFiles/Rates_JPsiCalculations.root","R");
    file_JPsi = new TFile("InRootFiles/03042015_JPsiCalculations.root","R");
    file_JPsi_V1 = new TFile("InRootFiles/03042015_SigmaDFac05_JPsiCalculations.root","R");
    file_JPsi_V2 = new TFile("InRootFiles/03042015_SigmaDFac15_JPsiCalculations.root","R");
    file_JPsi_V3= new TFile("InRootFiles/03042015_Tau01_JPsiCalculations.root","R");
    file_JPsi_V4 = new TFile("InRootFiles/03042015_Tau06_JPsiCalculations.root","R");
  }
  

  if(VarSet ==4){
    file_JPsi = new TFile("01052015_InRootFiles/JPsiCalculations.root","R");
    file_JPsi_V1 = new TFile("01052015_InRootFiles/SigmaDFac05_JPsiCalculations.root","R");
    file_JPsi_V2 = new TFile("01052015_InRootFiles/SigmaDFac15_JPsiCalculations.root","R");
    file_JPsi_V3= new TFile("01052015_InRootFiles/Tau001_JPsiCalculations.root","R");
    file_JPsi_V4 = new TFile("01052015_InRootFiles/Tau006_JPsiCalculations.root","R");
  }



  TFile *file_JPsi_For;
  TFile *file_JPsi_For_V1;
  TFile *file_JPsi_For_V2;
  TFile *file_JPsi_For_V3;
  TFile *file_JPsi_For_V4;
  
  if(VarSet ==1){
    file_JPsi_For = new TFile("InRootFiles/17032015_For_JPsiCalculations.root","R");
    file_JPsi_For_V1 = new TFile("InRootFiles/Fac05_For_JPsiCalculations.root","R");
    file_JPsi_For_V2 = new TFile("InRootFiles/Fac15_For_JPsiCalculations.root","R");
    file_JPsi_For_V3= new TFile("InRootFiles/Tau001_For_JPsiCalculations.root","R");
    file_JPsi_For_V4 = new TFile("InRootFiles/Tau006_For_JPsiCalculations.root","R");
  }

  if(VarSet ==2){
    file_JPsi_For = new TFile("InRootFiles/17032015_For_JPsiCalculations.root","R");
    file_JPsi_For_V1 = new TFile("InRootFiles/SigmaDFac08_For_JPsiCalculations.root","R");
    file_JPsi_For_V2 = new TFile("InRootFiles/SigmaDFac12_For_JPsiCalculations.root","R");
    file_JPsi_For_V3= new TFile("InRootFiles/Tau002_For_JPsiCalculations.root","R");
    file_JPsi_For_V4 = new TFile("InRootFiles/Tau004_For_JPsiCalculations.root","R");
  }


  if(VarSet ==3){
    file_JPsi_For = new TFile("InRootFiles/03042015_For_JPsiCalculations.root","R");
    file_JPsi_For_V1 = new TFile("InRootFiles/03042015_For_SigmaDFac05_JPsiCalculations.root","R");
    file_JPsi_For_V2 = new TFile("InRootFiles/03042015_For_SigmaDFac15_JPsiCalculations.root","R");
    file_JPsi_For_V3= new TFile("InRootFiles/03042015_For_Tau01_JPsiCalculations.root","R");
    file_JPsi_For_V4 = new TFile("InRootFiles/03042015_For_Tau06_JPsiCalculations.root","R");
  }
  

 if(VarSet ==4){
    file_JPsi_For = new TFile("01052015_InRootFiles/For_JPsiCalculations.root","R");
    file_JPsi_For_V1 = new TFile("01052015_InRootFiles/SigmaDFac05_For_JPsiCalculations.root","R");
    file_JPsi_For_V2 = new TFile("01052015_InRootFiles/SigmaDFac15_For_JPsiCalculations.root","R");
    file_JPsi_For_V3= new TFile("01052015_InRootFiles/Tau001_For_JPsiCalculations.root","R");
    file_JPsi_For_V4 = new TFile("01052015_InRootFiles/Tau006_For_JPsiCalculations.root","R");
  }
 ...
 //============================ ALICE RAA Vs NPart Graphs (Mid) =======================//
 
  TGraph *JPsi_grGluonDissALICENPart_Mid_M =(TGraph*)file_JPsi->Get("grDissALICE_M");
  JPsi_grGluonDissALICENPart_Mid_M->SetLineColor(2);
  JPsi_grGluonDissALICENPart_Mid_M->SetLineStyle(7);
  JPsi_grGluonDissALICENPart_Mid_M->SetLineWidth(2);


  TGraph *JPsi_grPionDissALICENPart_Mid_M =(TGraph*)file_JPsi->Get("grPionDissALICE_M");
  JPsi_grPionDissALICENPart_Mid_M->SetLineColor(4);
  JPsi_grPionDissALICENPart_Mid_M->SetLineStyle(9);
  JPsi_grPionDissALICENPart_Mid_M->SetLineWidth(2);


  TGraph *JPsi_grCNMEffALICENPart_Mid_M =(TGraph*)file_JPsi->Get("grCNMALICE_M");
  JPsi_grCNMEffALICENPart_Mid_M->SetLineColor(6);
  JPsi_grCNMEffALICENPart_Mid_M->SetLineStyle(6);
  JPsi_grCNMEffALICENPart_Mid_M->SetLineWidth(2);


  TGraph *JPsi_grRegenALICENPart_Mid_M =(TGraph*)file_JPsi->Get("grFormALICE_M");
  JPsi_grRegenALICENPart_Mid_M->SetLineColor(8);
  JPsi_grRegenALICENPart_Mid_M->SetLineStyle(2);
  JPsi_grRegenALICENPart_Mid_M->SetLineWidth(2);


  TGraph *JPsi_grRAAALICENPart_Mid_M =(TGraph*)file_JPsi->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_Mid_M->SetLineColor(1);
  JPsi_grRAAALICENPart_Mid_M->SetLineStyle(1);
  JPsi_grRAAALICENPart_Mid_M->SetLineWidth(2);



  TGraph *JPsi_grRAAALICENPart_Mid_M_V1 =(TGraph*)file_JPsi_V1->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_Mid_M_V1->SetLineColor(1);
  JPsi_grRAAALICENPart_Mid_M_V1->SetLineStyle(1);
  JPsi_grRAAALICENPart_Mid_M_V1->SetLineWidth(2);


  TGraph *JPsi_grRAAALICENPart_Mid_M_V2 =(TGraph*)file_JPsi_V2->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_Mid_M_V2->SetLineColor(1);
  JPsi_grRAAALICENPart_Mid_M_V2->SetLineStyle(1);
  JPsi_grRAAALICENPart_Mid_M_V2->SetLineWidth(2);



  TGraph *JPsi_grRAAALICENPart_Mid_M_V3 =(TGraph*)file_JPsi_V3->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_Mid_M_V3->SetLineColor(1);
  JPsi_grRAAALICENPart_Mid_M_V3->SetLineStyle(1);
  JPsi_grRAAALICENPart_Mid_M_V3->SetLineWidth(2);



  TGraph *JPsi_grRAAALICENPart_Mid_M_V4 =(TGraph*)file_JPsi_V4->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_Mid_M_V4->SetLineColor(1);
  JPsi_grRAAALICENPart_Mid_M_V4->SetLineStyle(1);
  JPsi_grRAAALICENPart_Mid_M_V4->SetLineWidth(2);





 //============================ ALICE RAA Vs NPart Graphs (Forward) =======================//
 
  TGraph *JPsi_grGluonDissALICENPart_M =(TGraph*)file_JPsi_For->Get("grDissALICE_M");
  ...
  TGraph *JPsi_grPionDissALICENPart_M =(TGraph*)file_JPsi_For->Get("grPionDissALICE_M");
  ...
  TGraph *JPsi_grRAAALICENPart_M_V1 =(TGraph*)file_JPsi_For_V1->Get("grRAAALICE_M");
  JPsi_grRAAALICENPart_M_V1->SetLineColor(1);
  JPsi_grRAAALICENPart_M_V1->SetLineStyle(1);
  JPsi_grRAAALICENPart_M_V1->SetLineWidth(2);


  TGraph *JPsi_grRAAALICENPart_M_V2 =(TGraph*)file_JPsi_For_V2->Get("grRAAALICE_M");
  ...
  TGraph *JPsi_grRAAALICENPart_M_V3 =(TGraph*)file_JPsi_For_V3->Get("grRAAALICE_M");
  ...
  TGraph *JPsi_grRAAALICENPart_M_V4 =(TGraph*)file_JPsi_For_V4->Get("grRAAALICE_M");
...
//============================ CMS RAA Vs NPart Graphs =======================//
  ...
  // Diss rates
  TLegend *legd_dissT = new TLegend( 0.17,0.70,0.62,0.93);
  legd_dissT->SetBorderSize(0);
  legd_dissT->SetFillStyle(0);
  legd_dissT->SetFillColor(0);
  legd_dissT->SetTextSize(0.045);
  
  legd_dissT->AddEntry(JPsi_DissRateVsT_KharPt0, "p_{T}= 0 GeV/c", "l");
  ...
  JPsi_DissRateVsT_KharPt0->GetYaxis()->SetRangeUser(0.0,5.0);
  TAxis *XaxisJPsi_DissRateVsT_KharPt0 = JPsi_DissRateVsT_KharPt0->GetXaxis();
  XaxisJPsi_DissRateVsT_KharPt0->SetLimits(0.17,0.6);
  ...
  JPsi_grFormRateVsT_MCInt_P1->GetYaxis()->SetTitleOffset(1.4);
  JPsi_grFormRateVsT_MCInt_P1->GetYaxis()->SetTitle("d#lambda_{F}/dp_{T}(fm^{2}GeV^{-1})");
  JPsi_grFormRateVsT_MCInt_P1->GetYaxis()->SetRangeUser(0.0001,1.0);

  TAxis *XaxisJPsi_grFormRateVsT_MCInt_P1  = JPsi_grFormRateVsT_MCInt_P1->GetXaxis();
  XaxisJPsi_grFormRateVsT_MCInt_P1->SetLimits(0.17,0.6);
  ...
  JPsi_grFormRateVsP_MCInt_T1->GetYaxis()->SetTitleOffset(1.4);
  ...
  JPsi_grRAAALICEPt_M_Shade->SetTitle("JPsi_grRAAALICEPt_M_Shade");
    ...
    grShJPsiVsPtALICE_Shade->SetFillStyle(3004);
  ...
  */
    ...
    TLegend *legd1 = new TLegend(0.17,0.57,0.90,0.94);
    ...
    JPsi_grRAAALICEPt_M->SetLineWidth(3);
    JPsi_grGluonDissALICEPt_M->SetLineWidth(3);
    JPsi_grPionDissALICEPt_M->SetLineWidth(3);
    JPsi_grRegenALICEPt_M->SetLineWidth(3);
    JPsi_grCNMEffALICEPt_M->SetLineWidth(3);
    ...
    legd1->Draw("same");
    tb->DrawLatex(0.85,0.91,"(a)");

    JPsi_grRAAALICEPt_M_Shade->Draw("fCsame");
    JPsi_grRAAUALICEPt_M->SetLineColor(12);
    JPsi_grRAAUALICEPt_M->Draw("Csame");
    JPsi_grRAALALICEPt_M->SetLineColor(12);
    JPsi_grRAALALICEPt_M->Draw("Csame");

    grShJPsiVsPtALICE_Shade->Draw("fsame");
    //    grShJPsiVsPtALICE->Draw("CSame");

    grShUJPsiVsPtALICE->SetLineColor(46);
    grShUJPsiVsPtALICE->Draw("CSame");
    grShLJPsiVsPtALICE->SetLineColor(46);
    grShLJPsiVsPtALICE->Draw("CSame");
    JPsi_grRAAALICEPt_M->Draw("Csame");
    ...
    gPad->SaveAs("plots/Fig5a_ALICE_RAAPt.pdf");
      ...
      for(Int_t i=0;i<NNPtCMS;i++)
	{
      ...
      grShJPsiVsPtCMS_Shade->SetFillStyle(3004);
      ...
      */
      ...
      JPsi_grRAACMSPt_M->SetLineWidth(3);
      JPsi_grGluonDissCMSPt_M->SetLineWidth(3);
      JPsi_grPionDissCMSPt_M->SetLineWidth(3);
      JPsi_grRegenCMSPt_M->SetLineWidth(3);
      JPsi_grCNMEffCMSPt_M->SetLineWidth(3);
      ...
      JPsi_grRAACMSPt_M_Shade->Draw("fCsame");
      JPsi_grRAAUCMSPt_M->SetLineColor(12);
      JPsi_grRAAUCMSPt_M->Draw("Csame");
      JPsi_grRAALCMSPt_M->SetLineColor(12);
      JPsi_grRAALCMSPt_M->Draw("Csame");
      grShJPsiVsPtCMS_Shade->Draw("fCsame");
      grShUJPsiVsPtCMS->SetLineColor(46);
      grShUJPsiVsPtCMS->Draw("CSame");
      grShLJPsiVsPtCMS->SetLineColor(46);
      grShLJPsiVsPtCMS->Draw("CSame");
      JPsi_grRAACMSPt_M->Draw("Csame");
      JPsi_grCNMEffCMSPt_M->Draw("Csame");
      ...
      gPad->SaveAs("plots/Fig5b_CMS_RAAPt.pdf");
      
 
      //return;
      
      //============== ALICE RAA Vs NPart JPsi (Mid) ====================//
      
      Int_t NNNPartALICEMid = 0;
      Double_t NPartALICEMid[20]={0}; 
      Double_t RAAALICENPart_Mid[20]={0};
      Double_t RAAUALICENPart_Mid[20]={0};
      Double_t RAALALICENPart_Mid[20]={0};

      NNNPartALICEMid=JPsi_grRAAALICENPart_Mid_M->GetN();
      cout<<" NNNPartALICEMid "<<NNNPartALICEMid<<endl;
 
      for (int j=0; j < JPsi_grRAAALICENPart_Mid_M->GetN();++j){
	...
	JPsi_grGluonDissALICENPart_Mid_M->GetPoint(j,NPart,JPsi_Gluon);
	JPsi_grPionDissALICENPart_Mid_M->GetPoint(j,NPart,JPsi_Pion);
	JPsi_grCNMEffALICENPart_Mid_M->GetPoint(j,NPart,JPsi_Shadow);
	JPsi_grRegenALICENPart_Mid_M->GetPoint(j,NPart,JPsi_Regen);
	JPsi_grRAAALICENPart_Mid_M->GetPoint(j,NPart,JPsi_RAA);
	...
	JPsi_grRAAALICENPart_Mid_M->SetPoint(j,NPart,RAATotal);
        JPsi_grGluonDissALICENPart_Mid_M->SetPoint(j,NPart,GluonTotal);  
        JPsi_grPionDissALICENPart_Mid_M->SetPoint(j,NPart,PionTotal);  
	JPsi_grCNMEffALICENPart_Mid_M->SetPoint(j,NPart,ShadowTotal);  
	JPsi_grRegenALICENPart_Mid_M->SetPoint(j,NPart,RegenTotal);
	...
	JPsi_grRAAALICENPart_Mid_M->GetPoint(j,NPart,y);
	JPsi_grRAAALICENPart_Mid_M_V1->GetPoint(j,NPart,y1);
	JPsi_grRAAALICENPart_Mid_M_V2->GetPoint(j,NPart,y2);
	JPsi_grRAAALICENPart_Mid_M_V3->GetPoint(j,NPart,y3);
	JPsi_grRAAALICENPart_Mid_M_V4->GetPoint(j,NPart,y4);
	...
	NPartALICEMid[j]=NPart;
	RAAALICENPart_Mid[j] = y;
	RAAUALICENPart_Mid[j] = yMax;
	RAALALICENPart_Mid[j] = yMin;
	// cout<<" Comover "<<PionTotal<<" CNM "<<ShadowTotal<<" Gluon "<<GluonTotal<<"  Regen "<< RegenTotal<<" RAA "<<RAATotal<<endl;
	cout<<NPart<<"   "<<RAALALICENPart_Mid[j]<<"   "<<RAAALICENPart_Mid[j]<<"   "<<RAAUALICENPart_Mid[j]<<endl;
      }
      ...
      TGraph *JPsi_grRAAALICENPart_Mid_M_Shade = new TGraph(2*NNNPartALICEMid);  
      for(Int_t i=0;i<NNNPartALICEMid;i++)
	{
	  JPsi_grRAAALICENPart_Mid_M_Shade->SetPoint(i,NPartALICEMid[i],RAAUALICENPart_Mid[i]);
	  JPsi_grRAAALICENPart_Mid_M_Shade->SetPoint(NNNPartALICEMid+i,NPartALICEMid[NNNPartALICEMid-i-1],RAALALICENPart_Mid[NNNPartALICEMid-i-1]);
	}
      
  
      TGraph *JPsi_grRAAUALICENPart_Mid_M = new TGraph(NNNPartALICEMid,NPartALICEMid,RAAUALICENPart_Mid); 
      TGraph *JPsi_grRAALALICENPart_Mid_M = new TGraph(NNNPartALICEMid,NPartALICEMid,RAALALICENPart_Mid); 
      
      JPsi_grRAAALICENPart_Mid_M_Shade->GetXaxis()->SetTitle("p_{T}(GeV/c)");
      JPsi_grRAAALICENPart_Mid_M_Shade->GetYaxis()->SetTitle("R_{AA}");
      JPsi_grRAAALICENPart_Mid_M_Shade->GetYaxis()->SetRangeUser(0.0,1.5);
      JPsi_grRAAALICENPart_Mid_M_Shade->SetName("JPsi_grRAAALICENPart_Mid_M_Shade");
      JPsi_grRAAALICENPart_Mid_M_Shade->SetTitle("JPsi_grRAAALICENPart_Mid_M_Shade");
      
    
      JPsi_grRAAALICENPart_Mid_M_Shade->SetFillStyle(3013);    
      JPsi_grRAAALICENPart_Mid_M_Shade->SetFillColor(16);  
      ...
      JPsi_grRAAALICENPart_Mid_M_Shade->Draw("fSame");
      */
    
      TLegend *Mid_legd3 = new TLegend(0.17,0.57,0.91,0.94);
      Mid_legd3->SetBorderSize(0);
      Mid_legd3->SetFillStyle(0);
      Mid_legd3->SetFillColor(0);
      Mid_legd3->SetTextSize(0.040);
      ...
      Draw_ALICEMid_JPsi_RaaVsNpart(Mid_legd3);
      
      Mid_legd3->AddEntry(JPsi_grGluonDissALICENPart_Mid_M,"Gluon Dissociation","L");
      Mid_legd3->AddEntry(JPsi_grPionDissALICENPart_Mid_M,"Comover","L");
      Mid_legd3->AddEntry(JPsi_grCNMEffALICENPart_Mid_M,"CNM Effects","L");
      Mid_legd3->AddEntry(JPsi_grRegenALICENPart_Mid_M,"Formation","L");
      Mid_legd3->AddEntry(JPsi_grRAAALICENPart_Mid_M,"Total (R_{AA})","L");
    
      
      JPsi_grRAAALICENPart_Mid_M->SetLineWidth(3);
      JPsi_grGluonDissALICENPart_Mid_M->SetLineWidth(3);
      JPsi_grPionDissALICENPart_Mid_M->SetLineWidth(3);
      JPsi_grCNMEffALICENPart_Mid_M->SetLineWidth(3);
      JPsi_grRegenALICENPart_Mid_M->SetLineWidth(3);


      JPsi_grRAAALICENPart_Mid_M->Draw("Csame");
      JPsi_grGluonDissALICENPart_Mid_M->Draw("Csame");
      JPsi_grPionDissALICENPart_Mid_M->Draw("Csame");
      JPsi_grCNMEffALICENPart_Mid_M->Draw("Csame");
      JPsi_grRegenALICENPart_Mid_M->Draw("Csame");
      
      Mid_legd3->Draw("same");
      tb->DrawLatex(0.85,0.91,"(a)");

      
      grShJPsiVsNPart_Y1_Shade->SetFillStyle(3004);
      grShJPsiVsNPart_Y1_Shade->SetFillColor(46);
      
      grShJPsiVsNPart_Y1_Shade->Draw("fCsame");
      grShUJPsiVsNPart_Y1->SetLineColor(46);
      grShUJPsiVsNPart_Y1->Draw("CSame");
      grShLJPsiVsNPart_Y1->SetLineColor(46);
      grShLJPsiVsNPart_Y1->Draw("CSame");
      

      JPsi_grRAAALICENPart_Mid_M_Shade->Draw("fsame");
      JPsi_grRAAUALICENPart_Mid_M->SetLineColor(12);
      JPsi_grRAAUALICENPart_Mid_M->Draw("Csame");
      JPsi_grRAALALICENPart_Mid_M->SetLineColor(12);
      JPsi_grRAALALICENPart_Mid_M->Draw("Csame");

      JPsi_grCNMEffALICENPart_Mid_M->Draw("Csame");

      gPad->SaveAs("plots/Fig7a_ALICE_RAANPartMid.eps");
      gPad->SaveAs("plots/Fig7a_ALICE_RAANPartMid.png");
      gPad->SaveAs("plots/Fig7a_ALICE_RAANPartMid.pdf");

      // return;
     
 //============== ALICE RAA Vs NPart JPsi (Forward) ====================//
      ...
      for(Int_t i=0;i<NNNPartALICE;i++)
	{
      ...
      grShJPsiVsNPart_Shade->SetFillStyle(3004);
      ...
      */
      //new TLegend(0.16,0.51,0.90,0.88);
      TLegend *legd3 = new TLegend(0.17,0.57,0.91,0.94);
      ...
      JPsi_grRAAALICENPart_M->SetLineWidth(3);
      JPsi_grGluonDissALICENPart_M->SetLineWidth(3);
      JPsi_grPionDissALICENPart_M->SetLineWidth(3);
      JPsi_grCNMEffALICENPart_M->SetLineWidth(3);
      JPsi_grRegenALICENPart_M->SetLineWidth(3);
      ...
      legd3->Draw("same");
      //tb->DrawLatex(0.85,0.94,"(a)");

      
      JPsi_grRAAALICENPart_M_Shade->Draw("fsame");
      JPsi_grRAAUALICENPart_M->SetLineColor(12);
      JPsi_grRAAUALICENPart_M->Draw("Csame");
      JPsi_grRAALALICENPart_M->SetLineColor(12);
      JPsi_grRAALALICENPart_M->Draw("Csame");
  
      
      grShJPsiVsNPart_Shade->Draw("fsame");
      grShUJPsiVsNPart->SetLineColor(46);
      grShUJPsiVsNPart->Draw("CSame");
      grShLJPsiVsNPart->SetLineColor(46);
      grShLJPsiVsNPart->Draw("CSame");
      JPsi_grRAAALICENPart_M->Draw("Csame");
      JPsi_grCNMEffALICENPart_M->Draw("Csame");
      
      
      gPad->SaveAs("plots/Fig6_ALICE_RAANPart.eps");
      gPad->SaveAs("plots/Fig6_ALICE_RAANPart.png");
      gPad->SaveAs("plots/Fig6_ALICE_RAANPart.pdf");
 ...
 grShJPsiPtCutVsNPart_Shade->SetFillStyle(3004);
 ...
 */
 ...
 TLegend *legd4 = new TLegend(0.18,0.55,0.80,0.94);
 ...
 JPsi_grRAACMSNPart_M->SetLineWidth(3);
 JPsi_grGluonDissCMSNPart_M->SetLineWidth(3);
 JPsi_grPionDissCMSNPart_M->SetLineWidth(3);
 JPsi_grCNMEffCMSNPart_M->SetLineWidth(3);
 JPsi_grRegenCMSNPart_M->SetLineWidth(3);
 ...
 legd4->Draw("same");
 tb->DrawLatex(0.85,0.92,"(b)");

 JPsi_grRAACMSNPart_M_Shade->Draw("fsame");
 JPsi_grRAAUCMSNPart_M->SetLineColor(12);
 JPsi_grRAAUCMSNPart_M->Draw("Csame");
 JPsi_grRAALCMSNPart_M->SetLineColor(12);
 JPsi_grRAALCMSNPart_M->Draw("Csame");
  
 
 grShJPsiPtCutVsNPart_Shade->Draw("fsame");
 grShUJPsiPtCutVsNPart->SetLineColor(46);
 grShUJPsiPtCutVsNPart->Draw("CSame");
 grShLJPsiPtCutVsNPart->SetLineColor(46);
 grShLJPsiPtCutVsNPart->Draw("CSame");
 JPsi_grRAACMSNPart_M->Draw("Csame");
 JPsi_grCNMEffCMSNPart_M->Draw("Csame");

 gPad->SaveAs("plots/Fig7b_CMS_RAANPart.eps");
 gPad->SaveAs("plots/Fig7b_CMS_RAANPart.png");
 gPad->SaveAs("plots/Fig7b_CMS_RAANPart.pdf");
...
//return;
 ...
 if(VarSet ==1){
   file_Y1S= new TFile("InRootFiles/04032015_Y1SCalculations.root","R");
   file_Y1S_V1 = new TFile("InRootFiles/SigmaDFac05_Y1SCalculations.root","R");
   file_Y1S_V2 = new TFile("InRootFiles/SigmaDFac15_Y1SCalculations.root","R");
   file_Y1S_V3 = new TFile("InRootFiles/Tau001_Y1SCalculations.root","R");
   file_Y1S_V4 = new TFile("InRootFiles/Tau006_Y1SCalculations.root","R"); 
 }


 if(VarSet ==2){
   file_Y1S= new TFile("InRootFiles/04032015_Y1SCalculations.root","R");
   file_Y1S_V1 = new TFile("InRootFiles/SigmaDFac08_Y1SCalculations.root","R");
   file_Y1S_V2 = new TFile("InRootFiles/SigmaDFac12_Y1SCalculations.root","R");
   file_Y1S_V3 = new TFile("InRootFiles/Tau002_Y1SCalculations.root","R");
   file_Y1S_V4 = new TFile("InRootFiles/Tau004_Y1SCalculations.root","R"); 
 }


 if(VarSet ==3){
   file_Y1S= new TFile("InRootFiles/03042015_Y1SCalculations.root","R");
   file_Y1S_V1 = new TFile("InRootFiles/03042015_SigmaDFac05_Y1SCalculations.root","R");
   file_Y1S_V2 = new TFile("InRootFiles/03042015_SigmaDFac15_Y1SCalculations.root","R");
   file_Y1S_V3 = new TFile("InRootFiles/03042015_Tau01_Y1SCalculations.root","R");
   file_Y1S_V4 = new TFile("InRootFiles/03042015_Tau06_Y1SCalculations.root","R"); 
 }


if(VarSet ==4){
   file_Y1S= new TFile("01052015_InRootFiles/Y1SCalculations.root","R");
   file_Y1S_V1 = new TFile("01052015_InRootFiles/SigmaDFac05_Y1SCalculations.root","R");
   file_Y1S_V2 = new TFile("01052015_InRootFiles/SigmaDFac15_Y1SCalculations.root","R");
   file_Y1S_V3 = new TFile("01052015_InRootFiles/Tau001_Y1SCalculations.root","R");
   file_Y1S_V4 = new TFile("01052015_InRootFiles/Tau006_Y1SCalculations.root","R"); 
 }
 ...
 TFile *file_Y1S_For;
 TFile *file_Y1S_For_V1;
 TFile *file_Y1S_For_V2;
 TFile *file_Y1S_For_V3;
 TFile *file_Y1S_For_V4;
 
 if(VarSet ==1){
   file_Y1S_For= new TFile("InRootFiles/20032015_For_Y1SCalculations.root","R");
   file_Y1S_For_V1 = new TFile("InRootFiles/SigmaDFac05_For_Y1SCalculations.root","R");
   file_Y1S_For_V2 = new TFile("InRootFiles/SigmaDFac15_For_Y1SCalculations.root","R");
   file_Y1S_For_V3 = new TFile("InRootFiles/Tau001_For_Y1SCalculations.root","R");
   file_Y1S_For_V4 = new TFile("InRootFiles/Tau006_For_Y1SCalculations.root","R"); 
 }


if(VarSet ==2){
  file_Y1S_For= new TFile("InRootFiles/20032015_For_Y1SCalculations.root","R");
  file_Y1S_For_V1 = new TFile("InRootFiles/SigmaDFac08_For_Y1SCalculations.root","R");
  file_Y1S_For_V2 = new TFile("InRootFiles/SigmaDFac12_For_Y1SCalculations.root","R");
  file_Y1S_For_V3 = new TFile("InRootFiles/Tau002_For_Y1SCalculations.root","R");
  file_Y1S_For_V4 = new TFile("InRootFiles/Tau004_For_Y1SCalculations.root","R"); 
 }



if(VarSet ==3){
  file_Y1S_For= new TFile("InRootFiles/03042015_For_Y1SCalculations.root","R");
  file_Y1S_For_V1 = new TFile("InRootFiles/03042015_For_SigmaDFac05_Y1SCalculations.root","R");
  file_Y1S_For_V2 = new TFile("InRootFiles/03042015_For_SigmaDFac15_Y1SCalculations.root","R");
  file_Y1S_For_V3 = new TFile("InRootFiles/03042015_For_Tau01_Y1SCalculations.root","R");
  file_Y1S_For_V4 = new TFile("InRootFiles/03042015_For_Tau06_Y1SCalculations.root","R"); 
 }
 

if(VarSet ==4){
  file_Y1S_For= new TFile("01052015_InRootFiles/For_Y1SCalculations.root","R");
  file_Y1S_For_V1 = new TFile("01052015_InRootFiles/SigmaD05_For_Y1SCalculations.root","R");
  file_Y1S_For_V2 = new TFile("01052015_InRootFiles/SigmaD15_For_Y1SCalculations.root","R");
  file_Y1S_For_V3 = new TFile("01052015_InRootFiles/Tau001_For_Y1SCalculations.root","R");
  file_Y1S_For_V4 = new TFile("01052015_InRootFiles/Tau006_For_Y1SCalculations.root","R"); 
 }



//================================================= Making cross section graphs ===================//
 
 TGraph *JPsi_SigmaD =(TGraph*)file_JPsi_For->Get("grSigDQ0");
 TGraph *Y1S_SigmaD =(TGraph*)file_Y1S_For->Get("grSigDQ0");
 ...
 //============================ ALICE RAA Vs NPart Graphs =======================//
  ...
  TGraph *Y1S_grGluonDissALICENPart_M =(TGraph*)file_Y1S_For->Get("grDissCMS_M");
  Y1S_grGluonDissALICENPart_M->SetLineColor(2);
  Y1S_grGluonDissALICENPart_M->SetLineStyle(7);
  Y1S_grGluonDissALICENPart_M->SetLineWidth(2);


  TGraph *Y1S_grPionDissALICENPart_M =(TGraph*)file_Y1S_For->Get("grPionDissCMS_M");
  Y1S_grPionDissALICENPart_M->SetLineColor(4);
  Y1S_grPionDissALICENPart_M->SetLineStyle(9);
  Y1S_grPionDissALICENPart_M->SetLineWidth(2);


  TGraph *Y1S_grCNMEffALICENPart_M =(TGraph*)file_Y1S_For->Get("grCNMCMS_M");
  Y1S_grCNMEffALICENPart_M->SetLineColor(6);
  Y1S_grCNMEffALICENPart_M->SetLineStyle(6);
  Y1S_grCNMEffALICENPart_M->SetLineWidth(2);


  TGraph *Y1S_grRegenALICENPart_M =(TGraph*)file_Y1S_For->Get("grFormCMS_M");
  Y1S_grRegenALICENPart_M->SetLineColor(8);
  Y1S_grRegenALICENPart_M->SetLineStyle(2);
  Y1S_grRegenALICENPart_M->SetLineWidth(2);


  TGraph *Y1S_grRAAALICENPart_M =(TGraph*)file_Y1S_For->Get("grRAACMS_M");
  ...
  TGraph *Y1S_grRAAALICENPart_M_V1 =(TGraph*)file_Y1S_For_V1->Get("grRAACMS_M");
  Y1S_grRAAALICENPart_M_V1->SetLineColor(1);
  Y1S_grRAAALICENPart_M_V1->SetLineStyle(1);
  Y1S_grRAAALICENPart_M_V1->SetLineWidth(2);



  TGraph *Y1S_grRAAALICENPart_M_V2 =(TGraph*)file_Y1S_For_V2->Get("grRAACMS_M");
  Y1S_grRAAALICENPart_M_V2->SetLineColor(1);
  Y1S_grRAAALICENPart_M_V2->SetLineStyle(1);
  Y1S_grRAAALICENPart_M_V2->SetLineWidth(2);


  TGraph *Y1S_grRAAALICENPart_M_V3 =(TGraph*)file_Y1S_For_V3->Get("grRAACMS_M");
  Y1S_grRAAALICENPart_M_V3->SetLineColor(1);
  Y1S_grRAAALICENPart_M_V3->SetLineStyle(1);
  Y1S_grRAAALICENPart_M_V3->SetLineWidth(2);

  TGraph *Y1S_grRAAALICENPart_M_V4 =(TGraph*)file_Y1S_For_V4->Get("grRAACMS_M");
  Y1S_grRAAALICENPart_M_V4->SetLineColor(1);
  Y1S_grRAAALICENPart_M_V4->SetLineStyle(1);
  Y1S_grRAAALICENPart_M_V4->SetLineWidth(2);




  //============== ALICE RAA Vs NPart Y1S ====================//
  
  Int_t Y1S_NNNPartALICE = 0;
  Double_t Y1S_NPartALICE[20]={0}; 
  

  Double_t Y1S_RAAALICENPart[20]={0};
  Double_t Y1S_RAAUALICENPart[20]={0};
  Double_t Y1S_RAALALICENPart[20]={0};
  
  Y1S_NNNPartALICE=Y1S_grRAAALICENPart_M->GetN();
  cout<<" Y1S NNNPartALICE "<<Y1S_NNNPartALICE<<endl;



 for (int j=0; j < Y1S_grRAAALICENPart_M->GetN();++j){
  
    Double_t NPart, GluonTotal, PionTotal, ShadowTotal, RegenTotal, RAATotal;
    Double_t Y1S_Gluon, Y1S_Pion, Y1S_Shadow, Y1S_Regen,Y1S_Total,Y1S_RAA;
    
    Y1S_grGluonDissALICENPart_M->GetPoint(j,NPart,Y1S_Gluon);
    Y1S_grPionDissALICENPart_M->GetPoint(j,NPart,Y1S_Pion);
    Y1S_grCNMEffALICENPart_M->GetPoint(j,NPart,Y1S_Shadow);
    Y1S_grRegenALICENPart_M->GetPoint(j,NPart,Y1S_Regen);
    Y1S_grRAAALICENPart_M->GetPoint(j,NPart,Y1S_RAA);
    ...
    Y1S_grRAAALICENPart_M->SetPoint(j,NPart,RAATotal);
    Y1S_grGluonDissALICENPart_M->SetPoint(j,NPart,GluonTotal);  
    Y1S_grPionDissALICENPart_M->SetPoint(j,NPart,PionTotal);  
    Y1S_grCNMEffALICENPart_M->SetPoint(j,NPart,ShadowTotal);  
    Y1S_grRegenALICENPart_M->SetPoint(j,NPart,RegenTotal);
    ...
    Y1S_grRAAALICENPart_M->GetPoint(j,NPart,y);
    Y1S_grRAAALICENPart_M_V1->GetPoint(j,NPart,y1);
    Y1S_grRAAALICENPart_M_V2->GetPoint(j,NPart,y2);
    Y1S_grRAAALICENPart_M_V3->GetPoint(j,NPart,y3);
    Y1S_grRAAALICENPart_M_V4->GetPoint(j,NPart,y4);
    ...
    Y1S_NPartALICE[j]=NPart;
    Y1S_RAAALICENPart[j] = y;
    Y1S_RAAUALICENPart[j] = yMax;
    Y1S_RAALALICENPart[j] = yMin;
    

    // cout<<" Comover "<<PionTotal<<" CNM "<<ShadowTotal<<" Gluon "<<GluonTotal<<"  Regen "<< RegenTotal<<" RAA "<<RAATotal<<endl;
    cout<<NPart<<"   "<<Y1S_RAALALICENPart[j]<<"   "<<Y1S_RAAALICENPart[j]<<"   "<<Y1S_RAAUALICENPart[j]<<endl;


 }


 TGraph *Y1S_grRAAALICENPart_M_Shade = new TGraph(2*Y1S_NNNPartALICE);  
 for(Int_t i=0;i<Y1S_NNNPartALICE;i++)
   {
     Y1S_grRAAALICENPart_M_Shade->SetPoint(i,Y1S_NPartALICE[i],Y1S_RAAUALICENPart[i]);
     Y1S_grRAAALICENPart_M_Shade->SetPoint(Y1S_NNNPartALICE+i,Y1S_NPartALICE[NNNPartALICE-i-1],Y1S_RAALALICENPart[NNNPartALICE-i-1]);
   }
 
  
 TGraph *Y1S_grRAAUALICENPart_M = new TGraph(Y1S_NNNPartALICE,Y1S_NPartALICE,Y1S_RAAUALICENPart); 
 TGraph *Y1S_grRAALALICENPart_M = new TGraph(Y1S_NNNPartALICE,Y1S_NPartALICE,Y1S_RAALALICENPart); 
 
 
 Y1S_grRAAALICENPart_M_Shade->GetXaxis()->SetTitle("N_{Part}");
 Y1S_grRAAALICENPart_M_Shade->GetYaxis()->SetTitle("R_{AA}");
 Y1S_grRAAALICENPart_M_Shade->GetYaxis()->SetRangeUser(0.0,1.5);
 Y1S_grRAAALICENPart_M_Shade->SetName("Y1S_grRAAALICENPart_M_Shade");
 Y1S_grRAAALICENPart_M_Shade->SetTitle("Y1S_grRAAALICENPart_M_Shade");
 
 grShUpsilonVsNPartFor_Shade->SetFillStyle(3004);
 grShUpsilonVsNPartFor_Shade->SetFillColor(46);

 //grShUpsilonVsNPartFor->SetLineColor(46);
 grShUUpsilonVsNPartFor->SetLineColor(46);

 grShLUpsilonVsNPartFor->SetLineColor(46);
 
 Y1S_grRAAALICENPart_M_Shade->SetFillStyle(3013);    
 Y1S_grRAAALICENPart_M_Shade->SetFillColor(16);  
...
/*
 ...
 grShUUpsilonVsNPartFor->Draw("lSame");
 grShLUpsilonVsNPartFor->Draw("lSame");
 Y1S_grRAAALICENPart_M_Shade->Draw("fSame");
 */
//new TLegend(0.18,0.52,0.80,0.88);
 TLegend *Forlegd5 = new TLegend(0.18,0.58,0.80,0.94);
 Forlegd5->SetBorderSize(0);
 Forlegd5->SetFillStyle(0);
 Forlegd5->SetFillColor(0);
 Forlegd5->SetTextSize(0.040);
 ...
 Draw_ALICEFor_Y1S_RaaVsNpart(Forlegd5);
 Forlegd5->AddEntry(Y1S_grGluonDissALICENPart_M,"Gluon Dissociation","L");
 Forlegd5->AddEntry(Y1S_grPionDissALICENPart_M,"Comover","L");
 Forlegd5->AddEntry(Y1S_grCNMEffALICENPart_M,"CNM Effects","L");
 Forlegd5->AddEntry(Y1S_grRAAALICENPart_M,"Total (R_{AA})","L");
 

 Y1S_grRAAALICENPart_M->SetLineWidth(3);
 Y1S_grGluonDissALICENPart_M->SetLineWidth(3);
 Y1S_grPionDissALICENPart_M->SetLineWidth(3);
 Y1S_grCNMEffALICENPart_M->SetLineWidth(3);

 Y1S_grRAAALICENPart_M->Draw("Csame");
 Y1S_grGluonDissALICENPart_M->Draw("Csame");
 Y1S_grPionDissALICENPart_M->Draw("Csame");
 Y1S_grCNMEffALICENPart_M->Draw("Csame"); 
 
 Forlegd5->Draw("same");
 //tb->DrawLatex(0.83,0.91,"(b)");


 Y1S_grRAAALICENPart_M_Shade->Draw("fsame");
 Y1S_grRAAUALICENPart_M->SetLineColor(12);
 Y1S_grRAAUALICENPart_M->Draw("Csame");
 Y1S_grRAALALICENPart_M->SetLineColor(12);
 Y1S_grRAALALICENPart_M->Draw("Csame");

 grShUpsilonVsNPartFor_Shade->Draw("fSame");
 //grShUpsilonVsNPartFor->Draw("CSame");
 grShUUpsilonVsNPartFor->Draw("CSame");
 grShLUpsilonVsNPartFor->Draw("CSame");

 Y1S_grRAAALICENPart_M->Draw("Csame");
 Y1S_grCNMEffALICENPart_M->Draw("Csame"); 

 gPad->SaveAs("plots/Fig9_ALICE_Y1SRAANPart.eps");
 gPad->SaveAs("plots/Fig9_ALICE_Y1SRAANPart.png");
 gPad->SaveAs("plots/Fig9_ALICE_Y1SRAANPart.pdf");
 ...
 grShUpsilonVsNPartMid_Shade->SetFillStyle(3004);
 ...
 */
 ...
 TLegend *legd5 = new TLegend(0.16,0.57,0.87,0.93);
 ...
 Y1S_grRAACMSNPart_M->SetLineWidth(3);
 Y1S_grGluonDissCMSNPart_M->SetLineWidth(3);
 Y1S_grPionDissCMSNPart_M->SetLineWidth(3);
 Y1S_grCNMEffCMSNPart_M->SetLineWidth(3);
 ...
 legd5->Draw("same");
 tb->DrawLatex(0.84,0.91,"(a)");



 Y1S_grRAACMSNPart_M_Shade->Draw("fsame");
 Y1S_grRAAUCMSNPart_M->SetLineColor(12);
 Y1S_grRAAUCMSNPart_M->Draw("Csame");
 Y1S_grRAALCMSNPart_M->SetLineColor(12);
 Y1S_grRAALCMSNPart_M->Draw("Csame");

 grShUpsilonVsNPartMid_Shade->Draw("fSame");
 //grShUpsilonVsNPartMid->Draw("CSame");
 grShUUpsilonVsNPartMid->Draw("CSame");
 grShLUpsilonVsNPartMid->Draw("CSame");


 Y1S_grRAACMSNPart_M->Draw("Csame");
 Y1S_grCNMEffCMSNPart_M->Draw("Csame"); 

 gPad->SaveAs("plots/Fig8a_CMS_Y1SRAANPart.eps");
 gPad->SaveAs("plots/Fig8a_CMS_Y1SRAANPart.png");
 gPad->SaveAs("plots/Fig8a_CMS_Y1SRAANPart.pdf");
 ...
 if(VarSet ==1){
   file_Y2S= new TFile("InRootFiles/04032015_Y2SCalculations.root","R");
   file_Y2S_V1 = new TFile("InRootFiles/SigmaDFac05_Y2SCalculations.root","R");
   file_Y2S_V2 = new TFile("InRootFiles/SigmaDFac15_Y2SCalculations.root","R");
   file_Y2S_V3 = new TFile("InRootFiles/Tau001_Y2SCalculations.root","R");
   file_Y2S_V4 = new TFile("InRootFiles/Tau006_Y2SCalculations.root","R"); 
 }


 if(VarSet ==2){
   file_Y2S= new TFile("InRootFiles/04032015_Y2SCalculations.root","R");
   file_Y2S_V1 = new TFile("InRootFiles/SigmaDFac08_Y2SCalculations.root","R");
   file_Y2S_V2 = new TFile("InRootFiles/SigmaDFac12_Y2SCalculations.root","R");
   file_Y2S_V3 = new TFile("InRootFiles/Tau002_Y2SCalculations.root","R");
   file_Y2S_V4 = new TFile("InRootFiles/Tau004_Y2SCalculations.root","R"); 
 }



 if(VarSet ==3){
   file_Y2S= new TFile("InRootFiles/03042015_Y2SCalculations.root","R");
   file_Y2S_V1 = new TFile("InRootFiles/03042015_Tau01_Y2SCalculations.root","R");
   file_Y2S_V2 = new TFile("InRootFiles/03042015_Tau06_Y2SCalculations.root","R");
   file_Y2S_V3 = new TFile("InRootFiles/03042015_SigmaDFac05_Y2SCalculations.root","R");
   file_Y2S_V4 = new TFile("InRootFiles/03042015_SigmaDFac15_Y2SCalculations.root","R"); 
 }

if(VarSet ==4){
   file_Y2S= new TFile("01052015_InRootFiles/Y2SCalculations.root","R");
   file_Y2S_V1 = new TFile("01052015_InRootFiles/SigmaDFac05_Y2SCalculations.root","R");
   file_Y2S_V2 = new TFile("01052015_InRootFiles/SigmaDFac15_Y2SCalculations.root","R"); 
   file_Y2S_V3 = new TFile("01052015_InRootFiles/Tau001_Y2SCalculations.root","R");
   file_Y2S_V4 = new TFile("01052015_InRootFiles/Tau006_Y2SCalculations.root","R");
 ...
 */
 ...
 Y2S_grRAACMSNPart_M->SetLineWidth(3);
 Y2S_grGluonDissCMSNPart_M->SetLineWidth(3);
 Y2S_grPionDissCMSNPart_M->SetLineWidth(3);
 Y2S_grCNMEffCMSNPart_M->SetLineWidth(3);
 ...
 legd6->Draw("same");
 tb->DrawLatex(0.84,0.91,"(b)");

 Y2S_grRAACMSNPart_M_Shade->Draw("fsame");
 Y2S_grRAAUCMSNPart_M->SetLineColor(12);
 Y2S_grRAAUCMSNPart_M->Draw("Csame");
 Y2S_grRAALCMSNPart_M->SetLineColor(12);
 Y2S_grRAALCMSNPart_M->Draw("Csame");
 ...
 gPad->SaveAs("plots/Fig8b_CMS_Y2SRAANPart.eps");
 gPad->SaveAs("plots/Fig8b_CMS_Y2SRAANPart.png");
 gPad->SaveAs("plots/Fig8b_CMS_Y2SRAANPart.pdf");
...
{  
  ...
  grRaaPtCMS->GetYaxis()->SetRangeUser(0,2.5);
  grRaaPtCMS->GetXaxis()->SetTitleSize(0.06);
  grRaaPtCMS->GetXaxis()->SetTitle("p_{T}(GeV/c)");
  grRaaPtCMS->GetYaxis()->SetTitleSize(0.06);
  ...
  CMSGlobalSysJPsiPt = new TBox(18.0-0.25, 1 - 0.075, 18.0+0.25, 1 + 0.075);
  ...
  lgd->AddEntry(grRaaPtCMS,"CMS Data |y^{J/#psi}| #leq 2.4", "P");
...
void Draw_ALICEFor_JPsi_RaaVspT(TLegend *lgd)
{
  ...
  Xaxis2->SetLimits(0.0,9.8);

  grRaaPtALICEFor->GetYaxis()->SetRangeUser(0,2.5);
  grRaaPtALICEFor->GetXaxis()->SetTitleSize(0.06);
  grRaaPtALICEFor->GetXaxis()->SetTitle("p_{T}(GeV/c)");
  grRaaPtALICEFor->GetYaxis()->SetTitleSize(0.06);
  grRaaPtALICEFor->GetYaxis()->SetTitle("R_{AA}");
  

  grRaaPtALICEFor->Draw("AP");

  TLine *lh4 = new TLine(0.0,1.0,9.8,1.0);
  lh4->SetLineColor(1);
  lh4->SetLineStyle(1);
  lh4->SetLineWidth(2);
  lh4->Draw("same");
  ...
  ALICEGlobalSysJPsiPtFor = new TBox(9.4-0.2, 1 - 0.08, 9.4+0.2, 1 + 0.08);
  ...
  lgd->AddEntry(grRaaPtALICEFor,"ALICE Data 2.5 #leq y^{J/#psi} #leq 4.0", "P");  
...
void Draw_ALICEFor_JPsi_RaaVspT_InMostCentral(TLegend *lgd)
{
  ...
  lgd->AddEntry(grRaaPtALICEFor,"ALICE Data 2.5#leqy^{J/#psi}#leq4.0, Cent [0-20 %]", "P");  
...
int nbins = 12;
  ...
  grRaaCMS->GetYaxis()->SetRangeUser(0,2.5);
  grRaaCMS->GetXaxis()->SetTitleSize(0.06);
  grRaaCMS->GetXaxis()->SetTitle("N_{Part}");
  grRaaCMS->GetYaxis()->SetTitleSize(0.06);
  grRaaCMS->GetYaxis()->SetTitle("R_{AA}");
  
  TAxis *XaxisgrRaaNPartCMS = grRaaCMS->GetXaxis();
  XaxisgrRaaNPartCMS->SetLimits(0.0,410.0);
  ...
  lgd->AddEntry(grRaaCMS,"CMS Data |y^{J/#psi}| #leq 2.4", "P");
...
void Draw_ALICEFor_JPsi_RaaVsNpart(TLegend *lgd)
{
  ...
  grRaaALICE->GetYaxis()->SetRangeUser(0,2.5);
  
  TAxis *Xaxis2 = grRaaALICE->GetXaxis();
  Xaxis2->SetLimits(0.0,410.0);

  grRaaALICE->GetXaxis()->SetTitleSize(0.06);
  grRaaALICE->GetXaxis()->SetTitle("N_{Part}");
  grRaaALICE->GetYaxis()->SetTitleSize(0.06);
  ...
  lgd->AddEntry(grRaaALICE,"ALICE Data 2.5 #leq y^{J/#psi} #leq 4.0","P");
...
void Draw_ALICEMid_JPsi_RaaVsNpart(TLegend *lgd)
{
  ...
  grRaaALICEMid->GetYaxis()->SetRangeUser(0,2.5);
  
  TAxis *Xaxis = grRaaALICEMid->GetXaxis();
  Xaxis->SetLimits(0.,410.0);
  grRaaALICEMid->GetXaxis()->SetTitleSize(0.06);
  grRaaALICEMid->GetXaxis()->SetTitle("N_{Part}");
  grRaaALICEMid->GetYaxis()->SetTitleSize(0.06);
  ...
  lgd->AddEntry(grRaaALICEMid,"ALICE Data |y^{J/#psi}| #leq 1.0","P");
...
void Draw_CMS_Y1S_RaaVsNpart(TLegend *lgd)
{
  ...
  RaaYCMS1Sdata->GetYaxis()->SetRangeUser(0.0,2.5);
  //RaaYCMS1Sdata->GetXaxis()->CenterTitle();

  TAxis *Xaxis = RaaYCMS1Sdata->GetXaxis();
  Xaxis->SetLimits(0.,410.0);

  RaaYCMS1Sdata->GetXaxis()->SetTitleSize(0.06);
  RaaYCMS1Sdata->GetXaxis()->SetTitle("N_{Part}");
  RaaYCMS1Sdata->GetYaxis()->SetTitleSize(0.06);
  ...
  TBox *GlobalSys1;
  GlobalSys1 = new TBox(390-5, 1 - 0.215, 390+5, 1 + 0.215);
  GlobalSys1->SetFillStyle(0000);
  GlobalSys1->SetLineColor(3);
  GlobalSys1->Draw("same"); 
  
  TBox *GlobalSys2;
  GlobalSys2 = new TBox(380-5, 1 - 0.125, 380+5, 1 + 0.125);
  ...
  lgd->AddEntry(RaaYCMS1Sdata,"CMS Data |y^{#varUpsilon(1S)}| #leq 2.4", "P");
...
void Draw_CMS_Y2S_RaaVsNpart(TLegend *lgd)
{
  ...
  RaaYCMS2Sdata->GetYaxis()->SetRangeUser(0.0,2.5);

  TAxis *Xaxis = RaaYCMS2Sdata->GetXaxis();
  Xaxis->SetLimits(0.,410.0);

  RaaYCMS2Sdata->GetXaxis()->SetTitleSize(0.06);
  RaaYCMS2Sdata->GetXaxis()->SetTitle("N_{Part}");
  RaaYCMS2Sdata->GetYaxis()->SetTitleSize(0.06);
  ...
  lgd->AddEntry(RaaYCMS2Sdata,"CMS Data |y^{#varUpsilon(2S)}| #leq 2.4", "P");
...
void Draw_ALICEFor_Y1S_RaaVsNpart(TLegend *lgd)
{
  ...
  */
  ...
  RaaYALICE1Sdata->GetYaxis()->SetRangeUser(0.0,2.5);
  RaaYALICE1Sdata->GetXaxis()->SetTitleSize(0.06);
  RaaYALICE1Sdata->GetXaxis()->SetTitle("N_{Part}");
  RaaYALICE1Sdata->GetYaxis()->SetTitleSize(0.06);
  RaaYALICE1Sdata->GetYaxis()->SetTitle("R_{AA}");
  
  TAxis *XAxis_RaaYALICE1Sdata=RaaYALICE1Sdata->GetXaxis();
  XAxis_RaaYALICE1Sdata->SetLimits(0.0,410);
  XAxis_RaaYALICE1Sdata->Draw();
  
  RaaYALICE1Sdata->Draw("AP");
  ...
  TLine *lhALICE1S = new TLine(0.0,1.0,400,1.0);
  ...
  lgd->AddEntry(RaaYALICE1Sdata,"ALICE Data 2.5 #leq y^{#varUpsilon(1S)} #leq 4.0", "P");
