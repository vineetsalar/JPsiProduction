...
void PlotShadowing()
{
  ...
  //============================= JPsi Raa Shadowing vs Rapidity =======================================================//
  /*
  Int_t JpsiNNRap = 14;
  ...
  */
  ...
  TH1D *HistJpsiRaaShVsPt_Y1 = new TH1D("HistJpsiRaaShVsPt_Y1","HistJpsiRaaShVsPt_Y1",40,0,20.0);
  TH1D *HistJpsiRaaShUVsPt_Y1 = new TH1D("HistJpsiRaaShUVsPt_Y1","HistJpsiRaaShUVsPt_Y1",40,0,20.0);
  TH1D *HistJpsiRaaShLVsPt_Y1 = new TH1D("HistJpsiRaaShLVsPt_Y1","HistJpsiRaaShLVsPt_Y1",40,0,20.0);
  ...
  gPad->SaveAs("JpsiRaaShVsPt_Y1.pdf");
  gPad->SaveAs("JpsiRaaShVsPt_Y1.png");
  gPad->SaveAs("JpsiRaaShVsPt_Y1.eps");
