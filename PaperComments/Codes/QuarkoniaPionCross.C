...
//sigma in fm^2 (1 fm^2 = 10 mb)
//==================== Parameters Upsilon(2S) =======================//
Int_t QQbarVar =5;
Double_t mJpsi = 10.02;
Double_t mQ =4.2 ;
Double_t ep0=1.10/2.0;
Double_t ep02=ep0*ep0;
Double_t mQ2 = mQ*mQ;
...
// ===================================== Calculate the cross section =====================================//
  ...
  Double_t SSJPsi[100]={4.00, 4.01, 4.03, 4.06, 4.09, 4.11, 4.12, 4.17, 4.22, 4.27, 4.28, 4.33, 4.43, 4.52, 4.73, 
			4.85, 5.11, 5.52, 5.92, 6.46, 7.05, 7.79, 8.60, 9.61, 10.79, 12.20, 13.70, 15.22, 17.40, 
			19.43, 21.96, 24.95, 28.36, 31.86, 35.99, 41.15, 46.49, 53.15, 59.35, 67.85, 76.65, 88.14, 
			100.16, 113.16, 128.60, 142.80, 162.26, 186.56, 210.78, 242.35};




  Double_t SigmaJPsiPion[100]={0.01, 0.02, 0.02, 0.02, 0.03, 0.04, 0.04, 0.05, 0.07, 0.08, 0.10, 0.12, 0.15, 0.18, 
			       0.23, 0.27, 0.33, 0.39, 0.47, 0.55, 0.64, 0.71, 0.82, 0.92, 1.03, 1.15, 1.28, 1.37, 
			       1.49, 1.59, 1.76, 1.89, 2.03, 2.17, 2.29, 2.48, 2.62, 2.82, 2.95, 3.18, 3.27, 3.54, 
			       3.71, 3.92, 4.10, 4.37, 4.50, 4.79, 5.02, 5.35};
...
Int_t NNY1S = 39;
 ...
 Double_t SSY1S[100]={10.68, 10.56, 10.62, 10.62, 10.75, 10.81, 10.88, 11.01, 11.08, 11.41, 11.69, 12.34, 12.95, 13.76, 
		      14.78, 16.28, 17.71, 20.09, 21.99, 24.65, 27.97, 31.36, 35.58, 40.13, 42.88, 48.36, 54.21, 61.89, 
		      68.96, 78.72, 89.32, 100.74, 115.00, 128.92, 147.16, 164.98, 187.19, 214.97, 242.45};

 Double_t SigmaY1SPion[100]={0.01, 0.01, 0.02, 0.02, 0.02, 0.03, 0.04, 0.05, 0.05, 0.07, 0.08, 0.10, 0.12, 0.14, 0.16, 
			     0.19, 0.22, 0.25, 0.28, 0.31, 0.34, 0.37, 0.40, 0.43, 0.45, 0.48, 0.51, 0.56, 0.60, 0.62, 
			     0.67, 0.71, 0.74, 0.79, 0.85, 0.86, 0.91, 0.97, 1.02};
