...
%when the binding potential between the constituents of a quarkonium state, 
...
%The ground states, $J/\psi$ and $\Upsilon(1S)$ are expected to dissolve at significantly higher temperatures than the more 
%loosely bound excited states. 
...
%\begin{eqnarray}
%\lambda_{F} &=&\frac{\int \sigma_{F}(s)\, v_{\rm rel}\,f_{c}(p_1)\, f_{\bar{c}} (p_2) \,d^{3}p_1 \,d^{3}p_2 \, \delta^{3}(\vec{p_{j/\psi}}-(\vec{p_1}-\vec{p_2}))} 
...
%rapidity. Similar regeneration is assumed at forward and mid-rapidity.}
