...

{
  ...
  TFile *file_JPsi;
  if(Var ==0){file_JPsi = new TFile("04032015_JPsiCalculations.root","R");}
  if(Var ==1){file_JPsi = new TFile("SigmaDFac05_JPsiCalculations.root","R");}
  if(Var ==2){file_JPsi = new TFile("SigmaDFac15_JPsiCalculations.root","R");}
  if(Var ==3){file_JPsi = new TFile("Tau001_JPsiCalculations.root","R");}
  if(Var ==4){file_JPsi = new TFile("Tau006_JPsiCalculations.root","R");}
...
//============================ CMS RAA Vs NPart Graphs =======================//
  ...
  //JPsi_DissRateVsT_KharPt0
  //JPsi_DissRateVsT_KharPt36
  //JPsi_DissRateVsT_KharPt86

  //JPsi_grDissRateVsPt_T200
  //JPsi_grDissRateVsPt_T400
  //JPsi_grDissRateVsPt_T600 
...
//================================ Open Y1S Root File ================================================//
 TFile *file_Y1S;
 if(Var ==0){file_Y1S= new TFile("04032015_Y1SCalculations.root","R");}
 if(Var ==1){file_Y1S = new TFile("SigmaDFac05_Y1SCalculations.root","R");}
 if(Var ==2){file_Y1S = new TFile("SigmaDFac15_Y1SCalculations.root","R");}
 if(Var ==3){file_Y1S = new TFile("Tau001_Y1SCalculations.root","R");}
 if(Var ==4){file_Y1S = new TFile("Tau006_Y1SCalculations.root","R");} 
