...
const Double_t nCC0 = (12.0*1658)/362.0; ;  // Initial with shadowing 
const Double_t nJpsi0 = (0.18*1658)/362.0;  // Initial pp to be used in RAA to be divided by 0.65 // now it is 0.932 (at three places) 
...
//const Double_t tau0 = 0.2;
const Double_t tau0 = 0.3; //nominal
//const Double_t tau0 = 0.4;
...
void jpsiProd()
{
  ...
  for(int i=0; i<NNPtCMS; i++) {
    ...
    FormationCMSPt[i]=NJPsiRegenCMSPt[i]/(NJPsiMB*JPsiIntSh*NJPsi0CMSPt[i]);
  ...
  Double_t PionDissRap =  PionDiss_PtInt(6.25);
	...
	//cout<<" Temp : "<<TempTau[j]<<" FQGP  "<< fQGP[j]<<endl;
      ...
      cout<<" Value of isUps: "<<isUps<<endl;
