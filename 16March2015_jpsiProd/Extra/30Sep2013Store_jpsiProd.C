 ...
 // Npart vs Ncoll graphs =========================================
  ...
  if( CheckFunctions ==0 || CheckFunctions ==1){
	...
	intformALICE =NJpsiStatALICE[i];
      ...
      cout << nPart[i]<<"  "<<"    " << T0Cent <<"     "<<tauCCent <<"  "<<R0Cent<<"  "<<RAACMS[i]*CNMEffects[i]<<"   "<<RAAALICE[i]*CNMEffects[i]<<endl;
...
Double_t TauToTemp_All(Int_t Flag, Double_t T0Cent, Double_t R0Cent, Double_t Tau) 
{
  ...
  //Tau0ToTauC(Int_t Flag, Double_t T0Cent, Double_t R0Cent)
  //TauCToTauh(Int_t Flag, Double_t TauC, Double_t R0Cent)
...
Double_t TauCToTauh(Int_t Flag, Double_t TauC, Double_t R0Cent)
{
  ...
  if(Flag ==2){
    ...
    do{
      ...
      //Double_t Fx = ah*TauHG*(R0Cent+0.5*aT*TauHG*TauHG)*(R0Cent+0.5*aT*TauHG*TauHG)-C;
      //Double_t FPrimex = 4.0*ah*(R0Cent*TauHG*TauHG + 0.5*aT*pow(TauHG,4.0))*(R0Cent*TauHG + aT*pow(TauHG,3.0));
