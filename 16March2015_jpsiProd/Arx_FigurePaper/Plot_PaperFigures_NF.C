...

{
  ...
  //================================ Open JPsi Root File ================================================//
  TFile *file_JPsi = new TFile("14082014_JPsiCalculations.root","R");
...
//================================ Open Y1S Root File ================================================//
  TFile *file_Y1S = new TFile("14082014_Y1SCalculations.root","R");
 ...
 //================================ Open Y2S Root File ================================================//
  TFile *file_Y2S = new TFile("14082014_Y2SCalculations.root","R");
