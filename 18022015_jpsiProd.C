...
//========================================================================//
  ...
  for(int l = 0; l<=NTemp; l++) {
    ...
    if(Form ==1){
      ...
      //LambdaF_TripleInt[l] = IntFormFun2(Temp[l]);
      ...
      cout<<" form rate vs T "<<endl;
      cout<<"Temp: "<<Temp[l]<<" 2.25   "<< LambdaFMC_P1[l]<<" 3.25  "<<LambdaFMC_P2[l]<<" 4.25   "<<LambdaFMC_P3[l]<<endl;
  ...
  int NP1=int((P1Max-P1Min)/P1Step);

  for(int l = 0; l<=NP1; l++) {

    P1[l]=P1Min+P1Step*l;

    LambdaF_P1[l]=FormRateMC_P(0.200,P1[l]);
    LambdaF_P2[l]=FormRateMC_P(0.400,P1[l]);
    LambdaF_P3[l]=FormRateMC_P(0.600,P1[l]);
    cout<<P1[l]<<"  "<< LambdaF_P1[l] <<"  "<<LambdaF_P2[l]<<"   "<<LambdaF_P3[l]<<endl;
  }
    

    
  TGraph *grFormRate_TripleInt_P1 = new TGraph(NP1,P1,LambdaF_P1);
  ...
  TGraph *grFormRate_TripleInt_P2 = new TGraph(NP1,P1,LambdaF_P2);
  ...
  TGraph *grFormRate_TripleInt_P3 = new TGraph(NP1,P1,LambdaF_P3);
